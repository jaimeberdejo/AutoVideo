# Roadmap Archive: v1.60.0 MVP Pipeline

**Archived:** 2026-05-29
**Status:** ✅ SHIPPED 2026-05-29
**Phases:** 1–7 (18 plans, 22 tasks)

This archive captures the phases shipped in v1.60.0. Phases 8–9 (Screenshot
and Video Clip support) were scoped after the audit and carried forward as
next-milestone work — see `.planning/ROADMAP.md`.
...
**Execution Order:**
Phases executed in numeric order: 1 → 2 → 3 → 4 → 5 → 6 → 7
